using LCH.Abp.AspNetCore.Mvc.GlobalFeatures;
using LCH.Abp.AspNetCore.Mvc.Localization;
using LCH.Abp.AspNetCore.Mvc.Results;
...
namespace LCH.Abp.AspNetCore.Mvc
{
    [DependsOn(
        ...
        public override void ConfigureServices(ServiceConfigurationContext context)
        {
            ...
            Configure<AbpLocalizationOptions>(options =>
            {
                options.Resources
                    ...
                    ).AddVirtualJson("/LCH/Abp/AspNetCore/Mvc/Localization/Resources");
            ...
            {
                options.RootDirectory = "/LCH/Abp/AspNetCore/Mvc";
            });
