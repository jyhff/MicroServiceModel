...
using LCH.Abp.Identity.Session;
using LCH.Abp.IdentityServer.IdentityResources;
...
using LCH.Abp.OpenIddict.Permissions;
...
public partial class MicroServiceApplicationsSingleModule
{
    ...
    private void PreConfigureAuthServer(IConfiguration configuration)
    {
        PreConfigure<OpenIddictBuilder>(builder =>
        {
            ...
            {
                //options.AddAudiences("lch-abp-application");
            ...
            options.AddPolicy(DefaultCorsPolicyName, builder =>
            {
                ...
                if (corsOrigins == "*")
                {
                    builder
                        ...
                        .AllowAnyHeader()
                        .AllowAnyMethod();
                        // .AllowCredentials(); // 与 AllowAnyOrigin 冲突，已注释
                }
                else
                {
                    builder
