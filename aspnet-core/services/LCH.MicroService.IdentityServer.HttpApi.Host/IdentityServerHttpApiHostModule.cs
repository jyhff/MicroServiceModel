...
[DependsOn(
    ...
    typeof(LCH.Abp.Account.AbpAccountApplicationModule),
    typeof(LCH.Abp.Account.AbpAccountHttpApiModule),
    typeof(LCH.Abp.Identity.AbpIdentityApplicationModule),
    typeof(LCH.Abp.Identity.AbpIdentityHttpApiModule),
    typeof(LCH.Abp.IdentityServer.AbpIdentityServerApplicationModule),
    typeof(LCH.Abp.IdentityServer.AbpIdentityServerHttpApiModule),
    typeof(LCH.Abp.Identity.EntityFrameworkCore.AbpIdentityEntityFrameworkCoreModule),
    typeof(LCH.Abp.IdentityServer.EntityFrameworkCore.AbpIdentityServerEntityFrameworkCoreModule),
