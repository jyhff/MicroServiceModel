...
public partial class IdentityServerHttpApiHostModule
{
    ...
    private void ConfigurePermissionManagement()
    {
        Configure<PermissionManagementOptions>(options =>
        {
            ...
            options.ProviderPolicies[ClientPermissionValueProvider.ProviderName] =
                LCH.Abp.IdentityServer.AbpIdentityServerPermissions.Clients.ManagePermissions;
        });
    }
    ...
    private void ConfigureVirtualFileSystem()
    {
        ...
        {
            options.FileSets.AddEmbedded<IdentityServerHttpApiHostModule>("LCH.MicroService.IdentityServer");
        });
    }
