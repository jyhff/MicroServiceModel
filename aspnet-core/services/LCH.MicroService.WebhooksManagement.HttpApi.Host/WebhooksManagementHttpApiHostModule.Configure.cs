...
using LCH.Abp.Webhooks.BackgroundJobs;
...
public partial class WebhooksManagementHttpApiHostModule
{
    ...
    private void ConfigureBackgroundTasks(IServiceCollection services, IConfiguration configuration)
    {
        ...
        Configure<AbpBackgroundTasksOptions>(options =>
        {
            ...
            //    "LCH.Abp.Webhooks.BackgroundJobs",
            //    job =>
            //    {
            //        // more
            //    });
    ...
    private void ConfigureVirtualFileSystem()
    {
        ...
        {
            options.FileSets.AddEmbedded<WebhooksManagementHttpApiHostModule>("LCH.MicroService.WebhooksManagement");
        });
    }
