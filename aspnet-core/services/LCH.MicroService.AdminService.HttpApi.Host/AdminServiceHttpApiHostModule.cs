...
namespace LCH.MicroService.AdminService;
...
public partial class AdminServiceHttpApiHostModule : AbpModule
{
    ...
    public override void OnApplicationInitialization(ApplicationInitializationContext context)
    {
        ...
        {
            options.SwaggerEndpoint("/swagger/v1/swagger.json", "AdminService API");
        });
        app.UseAuditing();
