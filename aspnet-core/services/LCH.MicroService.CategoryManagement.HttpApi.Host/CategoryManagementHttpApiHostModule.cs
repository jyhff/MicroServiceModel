...
using LCH.Abp.CategoryManagement;
using LCH.Abp.CategoryManagement.EntityFrameworkCore;
...
[DependsOn(
    ...
    typeof(AbpCategoryManagementHttpApiModule),
    typeof(AbpCategoryManagementEntityFrameworkCoreModule),
    typeof(AbpCategoryManagementApplicationModule),
...
public partial class CategoryManagementHttpApiHostModule : AbpModule
{
    ...
    public override void OnApplicationInitialization(ApplicationInitializationContext context)
    {
        ...
        {
            options.SwaggerEndpoint("/swagger/v1/swagger.json", "Category Management Service API");
