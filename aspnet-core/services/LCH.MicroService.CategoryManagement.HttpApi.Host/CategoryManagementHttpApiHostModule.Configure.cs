...
public partial class CategoryManagementHttpApiHostModule
{
    public static string ApplicationName { get; set; } = "CategoryService";
    ...
    private void PreConfigureApp(IConfiguration configuration)
    {
        ...
        {
            options.SnowflakeIdOptions.WorkerId = 8;
    ...
    private void ConfigureVirtualFileSystem()
    {
        ...
        {
            options.FileSets.AddEmbedded<CategoryManagementHttpApiHostModule>("LCH.MicroService.CategoryManagement");
        });
    }
    ...
    private void ConfigureSwagger(IServiceCollection services, IConfiguration configuration)
    {
        services.AddAbpSwaggerGenWithOAuth(
            ...
            {
                { configuration["AuthServer:Audience"], "Category Service API"}
            },
            options =>
            {
                options.SwaggerDoc("v1", new OpenApiInfo
                {
                    Title = "Category Management Service API", Version = "v1",
                    Contact = new OpenApiContact
                    {
                        Name = "LCH",
                        Email = "support@lch.com",
