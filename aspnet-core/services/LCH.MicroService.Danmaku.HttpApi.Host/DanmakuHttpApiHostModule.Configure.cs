...
public partial class DanmakuHttpApiHostModule
{
    public static string ApplicationName { get; set; } = "DanmakuService";
    ...
    private void ConfigureVirtualFileSystem()
    {
        ...
        {
            options.FileSets.AddEmbedded<DanmakuHttpApiHostModule>("LCH.MicroService.Danmaku");
        });
    }
    ...
    private void ConfigureSwagger(IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddAbpSwaggerGenWithOAuth(
            ...
            {
                { configuration["AuthServer:Audience"], "Danmaku Service API"}
            },
            options =>
            {
                options.SwaggerDoc("v1", new OpenApiInfo
                {
                    Title = "Danmaku Service API", Version = "v1",
