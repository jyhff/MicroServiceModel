...
using LCH.MicroService.PlatformManagement.Messages;
...
public partial class PlatformManagementHttpApiHostModule
{
    ...
    private void ConfigureVirtualFileSystem()
    {
        ...
        {
            options.FileSets.AddEmbedded<PlatformManagementHttpApiHostModule>("LCH.MicroService.PlatformManagement");
        });
    }
