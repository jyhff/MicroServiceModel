...
[DependsOn(
    ...
    typeof(LCH.Abp.OpenIddict.AspNetCore.AbpOpenIddictAspNetCoreModule),
    // OpenIddict扩展模块 会话
    ...
    // 功能管理模块 应用服务
    typeof(LCH.Abp.FeatureManagement.AbpFeatureManagementApplicationModule),
    // 功能管理模块 控制器
    typeof(LCH.Abp.FeatureManagement.HttpApi.AbpFeatureManagementHttpApiModule),
    // 功能管理模块 实体框架
    ...
    // 权限管理模块 应用服务
    typeof(LCH.Abp.PermissionManagement.AbpPermissionManagementApplicationModule),
    // 权限管理模块 控制器
