...
using LCH.MicroService.Applications.Single.BackgroundJobs;
using LCH.MicroService.Applications.Single.MultiTenancy;
...
namespace LCH.MicroService.Applications.Single.EventBus.Distributed
{
    /// <summary>
    /// 订阅通知发布事件,统一发布消息
    /// </summary>
