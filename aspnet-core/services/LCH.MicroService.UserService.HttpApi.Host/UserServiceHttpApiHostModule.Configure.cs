...
public partial class UserServiceHttpApiHostModule
{
    public static string ApplicationName { get; set; } = "UserService";
    ...
    private void PreConfigureApp(IConfiguration configuration)
    {
        ...
        {
            options.SnowflakeIdOptions.WorkerId = 9;
    ...
    private void PreConfigureCAP(IConfiguration configuration)
    {
        ...
        {
            options
            .UsePostgreSql(postgreSqlOptions =>
            {
                configuration.GetSection("CAP:PostgreSql").Bind(postgreSqlOptions);
            })
    ...
    private void ConfigureVirtualFileSystem()
    {
        ...
        {
            options.FileSets.AddEmbedded<UserServiceHttpApiHostModule>("LCH.MicroService.UserService");
        });
    }
    ...
    private void ConfigureSwagger(IServiceCollection services, IConfiguration configuration)
    {
        services.AddAbpSwaggerGenWithOAuth(
            ...
            {
                { configuration["AuthServer:Audience"], "User Service API"}
            },
            options =>
            {
                options.SwaggerDoc("v1", new OpenApiInfo
                {
                    ...
                    Contact = new OpenApiContact
                    {
                        Name = "LCH",
                        Email = "admin@lch.com",
                        Url = new Uri("https://github.com/lch")
                    },
