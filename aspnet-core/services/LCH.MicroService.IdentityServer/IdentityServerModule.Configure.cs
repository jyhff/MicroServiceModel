...
using LCH.MicroService.IdentityServer.Authentication;
using LCH.MicroService.IdentityServer.IdentityResources;
...
public partial class IdentityServerModule
{
    ...
    private void ConfigureVirtualFileSystem(IWebHostEnvironment hostingEnvironment)
    {
        ...
        {
            options.FileSets.AddEmbedded<IdentityServerModule>("LCH.MicroService.IdentityServer");
        });
