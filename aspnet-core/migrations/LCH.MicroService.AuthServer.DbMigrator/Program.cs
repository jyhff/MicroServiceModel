...
#if DEBUG
                .MinimumLevel.Override("LCH.MicroService.AuthServer.DbMigrator", LogEventLevel.Debug)
#else
                .MinimumLevel.Override("LCH.MicroService.AuthServer.DbMigrator", LogEventLevel.Information)
#endif
