...
#if DEBUG
                .MinimumLevel.Override("LCH.MicroService.BackendAdmin.DbMigrator", LogEventLevel.Debug)
#else
                .MinimumLevel.Override("LCH.MicroService.BackendAdmin.DbMigrator", LogEventLevel.Information)
#endif
