...
#if DEBUG
                .MinimumLevel.Override("LCH.MicroService.TaskManagement.DbMigrator", LogEventLevel.Debug)
#else
                .MinimumLevel.Override("LCH.MicroService.TaskManagement.DbMigrator", LogEventLevel.Information)
#endif
