...
$dbContexts = @{
    "1" = @{
        Name = "LCH.MicroService.Applications.Single.EntityFrameworkCore.MySql"
        Context = "SingleMigrationsDbContext"
        Factory = "SingleMigrationsDbContextFactory"
    }
    "2" = @{
        Name = "LCH.MicroService.Applications.Single.EntityFrameworkCore.PostgreSql"
        Context = "SingleMigrationsDbContext"
        Factory = "SingleMigrationsDbContextFactory"
    }
    "3" = @{
        Name = "LCH.MicroService.Applications.Single.EntityFrameworkCore.SqlServer"
        Context = "SingleMigrationsDbContext"
        Factory = "SingleMigrationsDbContextFactory"
    }
}
