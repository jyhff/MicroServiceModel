...
#if DEBUG
                .MinimumLevel.Override("LCH.MicroService.LocalizationManagement.DbMigrator", LogEventLevel.Debug)
#else
                .MinimumLevel.Override("LCH.MicroService.LocalizationManagement.DbMigrator", LogEventLevel.Information)
#endif
