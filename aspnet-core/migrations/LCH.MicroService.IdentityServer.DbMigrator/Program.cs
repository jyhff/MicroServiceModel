...
#if DEBUG
                .MinimumLevel.Override("LCH.MicroService.IdentityServer.DbMigrator", LogEventLevel.Debug)
#else
                .MinimumLevel.Override("LCH.MicroService.IdentityServer.DbMigrator", LogEventLevel.Information)
#endif
