...
#if DEBUG
                .MinimumLevel.Override("LCH.MicroService.RealtimeMessage.DbMigrator", LogEventLevel.Debug)
#else
                .MinimumLevel.Override("LCH.MicroService.RealtimeMessage.DbMigrator", LogEventLevel.Information)
#endif
