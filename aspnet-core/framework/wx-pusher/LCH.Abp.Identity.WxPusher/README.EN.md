...
```bash
dotnet add package LCH.Abp.Identity.WxPusher
```
...
[LCH.Abp.Identity.WxPusher](https://github.com/colinin/abp-next-admin/tree/master/aspnet-core/framework/wx-pusher/LCH.Abp.Identity.WxPusher)
