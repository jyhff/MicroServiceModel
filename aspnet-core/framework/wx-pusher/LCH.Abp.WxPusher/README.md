...
```bash
dotnet add package LCH.Abp.WxPusher
```
...
[LCH.Abp.WxPusher](https://github.com/colinin/abp-next-admin/tree/master/aspnet-core/framework/wx-pusher/LCH.Abp.WxPusher)
