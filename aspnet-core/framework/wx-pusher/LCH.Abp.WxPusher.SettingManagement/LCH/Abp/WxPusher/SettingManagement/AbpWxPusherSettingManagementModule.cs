using LCH.Abp.WxPusher.Localization;
...
namespace LCH.Abp.WxPusher.SettingManagement;
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                ...
                .AddVirtualJson("/LCH/Abp/WxPusher/SettingManagement/Localization/Resources");
        });
