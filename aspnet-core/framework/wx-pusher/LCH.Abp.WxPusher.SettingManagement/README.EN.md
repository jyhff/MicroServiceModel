# LCH.Abp.WxPusher.SettingManagement
...
```bash
dotnet add package LCH.Abp.WxPusher.SettingManagement
```
...
[LCH.Abp.WxPusher.SettingManagement](https://github.com/colinin/abp-next-admin/tree/master/aspnet-core/framework/wx-pusher/LCH.Abp.WxPusher.SettingManagement)
