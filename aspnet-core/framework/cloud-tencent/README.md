# LCH.Abp.Tencent 模块概述

## 简介
LCH.Abp.Tencent 模块集成了腾讯云的各项服务，提供了对腾讯云服务的全面支持，包括对象存储、短信服务、QQ 互联和语音合成等功能。

## 包含的项目列表
- **LCH.Abp.Tencent**
- **LCH.Abp.BlobStoring.Tencent**
- **LCH.Abp.Sms.Tencent**
- **LCH.Abp.Tencent.QQ**
- **LCH.Abp.Tencent.SettingManagement**
- **LCH.Abp.Tencent.TTS**
