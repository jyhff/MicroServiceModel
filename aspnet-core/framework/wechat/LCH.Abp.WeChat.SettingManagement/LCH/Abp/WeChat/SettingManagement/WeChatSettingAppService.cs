...
using LCH.Abp.WeChat.MiniProgram.Features;
using LCH.Abp.WeChat.MiniProgram.Settings;
using LCH.Abp.WeChat.Official.Features;
using LCH.Abp.WeChat.Official.Settings;
using LCH.Abp.WeChat.Settings;
using LCH.Abp.WeChat.Work.Contacts.Features;
using LCH.Abp.WeChat.Work.Contacts.Settings;
using LCH.Abp.WeChat.Work.ExternalContact.Features;
using LCH.Abp.WeChat.Work.ExternalContact.Settings;
