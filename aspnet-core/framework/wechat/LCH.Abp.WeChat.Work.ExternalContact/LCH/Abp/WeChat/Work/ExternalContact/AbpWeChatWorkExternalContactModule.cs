using LCH.Abp.WeChat.Common;
using LCH.Abp.WeChat.Common.Messages;
using LCH.Abp.WeChat.Work.Common.Messages;
using LCH.Abp.WeChat.Work.ExternalContact.Messages.Models;
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                ...
                .AddVirtualJson("/LCH/Abp/WeChat/Work/ExternalContact/Localization/Resources");
        });
    }
}
