using LCH.Abp.WeChat.Work.ExternalContact.Customers.Request;
using LCH.Abp.WeChat.Work.ExternalContact.Customers.Response;
...
namespace LCH.Abp.WeChat.Work.ExternalContact.Customers;
