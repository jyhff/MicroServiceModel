...
using LCH.Abp.WeChat.Work.ExternalContact.Transfers.Request;
using LCH.Abp.WeChat.Work.ExternalContact.Transfers.Response;
...
namespace LCH.Abp.WeChat.Work.ExternalContact.Transfers;
