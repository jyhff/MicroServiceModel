...
using LCH.Abp.WeChat.Work.ExternalContact.Tags.Request;
using LCH.Abp.WeChat.Work.ExternalContact.Tags.Response;
...
namespace LCH.Abp.WeChat.Work.ExternalContact.Tags;
