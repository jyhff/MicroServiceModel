using LCH.Abp.WeChat.Work.ExternalContact.Attachments.Request;
using LCH.Abp.WeChat.Work.ExternalContact.Attachments.Response;
...
namespace LCH.Abp.WeChat.Work.ExternalContact.Attachments;
