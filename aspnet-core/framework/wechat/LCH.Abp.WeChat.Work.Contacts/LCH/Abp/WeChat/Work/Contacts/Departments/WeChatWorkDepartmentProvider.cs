using LCH.Abp.WeChat.Work.Contacts.Departments.Request;
using LCH.Abp.WeChat.Work.Contacts.Departments.Response;
using LCH.Abp.WeChat.Work.Contacts.Features;
using LCH.Abp.WeChat.Work.Contacts.Token;
...
namespace LCH.Abp.WeChat.Work.Contacts.Departments;
