using LCH.Abp.AspNetCore.Mvc.Wrapper.Filters;
using LCH.Abp.AspNetCore.Mvc.Wrapper.Localization;
...
namespace LCH.Abp.AspNetCore.Mvc.Wrapper;
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                ...
                .AddVirtualJson("/LCH/Abp/AspNetCore/Mvc/Wrapper/Localization/Resources");
        });
