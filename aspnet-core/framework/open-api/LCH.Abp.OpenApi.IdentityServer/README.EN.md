# LCH.Abp.OpenApi.IdentityServer
...
```bash
dotnet add package LCH.Abp.OpenApi.IdentityServer
```
...
* [LCH.Abp.OpenApi](../LCH.Abp.OpenApi/README.md)
* [LCH.Abp.OpenApi.Authorization](../LCH.Abp.OpenApi.Authorization/README.md)
