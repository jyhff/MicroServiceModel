using LCH.Abp.FeatureManagement.Client;
using LCH.Abp.FeatureManagement.Client.Permissions;
using LCH.Abp.Features.Client;
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                ...
                .AddVirtualJson("/LCH/Abp/FeatureManagement/Client/Localization/Resources");
        });
    }
}
