...
```bash
dotnet add package LCH.Abp.Localization.Xml
```
...
This module uses the [XmlLocalizationFile](./LCH/Abp/Localization/Xml/XmlLocalizationFile.cs) type for XML file serialization and deserialization.
