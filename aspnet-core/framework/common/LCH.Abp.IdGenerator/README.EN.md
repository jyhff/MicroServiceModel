...
`LCH.Abp.IdGenerator` is a distributed ID generator module that implements the Snowflake algorithm to generate distributed unique IDs.
...
```bash
dotnet add package LCH.Abp.IdGenerator
```
