# LCH.Abp.Location.Tencent

## Introduction

`LCH.Abp.Location.Tencent` is a location service implementation module based on Tencent Maps API, providing functionalities such as geocoding, reverse geocoding, IP location, and more.
...
```bash
dotnet add package LCH.Abp.Location.Tencent
```
