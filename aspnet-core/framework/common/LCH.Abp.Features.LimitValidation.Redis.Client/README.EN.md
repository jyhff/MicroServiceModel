# LCH.Abp.Features.LimitValidation.Redis.Client

Redis-based client feature limit validation component

## Features

* Inherits all functionality from LCH.Abp.Features.LimitValidation.Redis
...
2. Configure Redis options (same as LCH.Abp.Features.LimitValidation.Redis)
