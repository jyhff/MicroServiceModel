...
`LCH.Abp.Location` is a location service foundation module that provides geographic location-related functionality, including geocoding (forward/reverse), distance calculation, and more.
...
```bash
dotnet add package LCH.Abp.Location
```
...
* [中文文档](./README.md)
* [Baidu Maps Location Service](./LCH.Abp.Location.Baidu/README.EN.md)
* [Tencent Maps Location Service](./LCH.Abp.Location.Tencent/README.EN.md)
