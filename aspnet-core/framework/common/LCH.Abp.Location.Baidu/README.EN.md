# LCH.Abp.Location.Baidu

## Introduction

`LCH.Abp.Location.Baidu` is a location service implementation module based on Baidu Maps API, providing functionalities such as geocoding, reverse geocoding, IP location, and more.
...
```bash
dotnet add package LCH.Abp.Location.Baidu
```
