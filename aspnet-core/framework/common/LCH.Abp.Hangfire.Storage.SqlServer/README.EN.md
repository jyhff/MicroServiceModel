# LCH.Abp.Hangfire.Storage.SqlServer

English | [简体中文](README.md)

## 1. Introduction

`LCH.Abp.Hangfire.Storage.SqlServer` is an ABP module for configuring Hangfire to use SQL Server as storage. This module provides a simple configuration approach to easily use SQL Server as Hangfire's persistent storage.
...
```bash
dotnet add package LCH.Abp.Hangfire.Storage.SqlServer
```
