# LCH.Abp.Hangfire.Storage.MySql

English | [简体中文](README.md)

## 1. Introduction

`LCH.Abp.Hangfire.Storage.MySql` is an ABP module for configuring Hangfire to use MySQL as storage. This module provides a simple configuration approach to easily use MySQL as Hangfire's persistent storage.
...
```bash
dotnet add package LCH.Abp.Hangfire.Storage.MySql
```
