...
`LCH.Abp.BackgroundJobs.Hangfire` is an ABP background job module implemented based on [Hangfire](https://www.hangfire.io/). It provides a reliable background job execution framework that supports immediate, delayed, and recurring task execution.
...
```bash
dotnet add package LCH.Abp.BackgroundJobs.Hangfire
```
