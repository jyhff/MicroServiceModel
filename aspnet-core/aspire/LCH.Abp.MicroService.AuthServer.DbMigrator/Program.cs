using LCH.Abp.MicroService.AuthServer;
...
#if DEBUG
        .MinimumLevel.Override("LCH.Abp.MicroService.AuthServer", LogEventLevel.Debug)
#else
        .MinimumLevel.Override("LCH.Abp.MicroService.AuthServer", LogEventLevel.Information)
#endif
