...
var localizationService = AddDotNetProject<
    Projects.LCH_Abp_MicroService_LocalizationService_DbMigrator,
    Projects.LCH_Abp_MicroService_LocalizationService>(
    builder:            builder, 
...
var authServer = AddDotNetProject<
    Projects.LCH_Abp_MicroService_AuthServer_DbMigrator,
    Projects.LCH_Abp_MicroService_AuthServer>(
    builder:            builder,
    servicePrefix:      "Auth",
...
var adminService = AddDotNetProject<
    Projects.LCH_Abp_MicroService_AdminService_DbMigrator,
    Projects.LCH_Abp_MicroService_AdminService>(
    builder:            builder,
    servicePrefix:      "Admin",
    serviceSuffix:      "Service",
    migratorSuffix:     "Migrator",
...
AddDotNetProject<
    Projects.LCH_Abp_MicroService_AuthServer_DbMigrator,
    Projects.LCH_Abp_MicroService_IdentityService>(
    builder:            builder,
...
var taskService = AddDotNetProject<
    Projects.LCH_Abp_MicroService_TaskService_DbMigrator,
    Projects.LCH_Abp_MicroService_TaskService>(
    builder:            builder, 
    servicePrefix:      "Task", 
    serviceSuffix:      "Service",
    migratorSuffix:     "Migrator",
...
// MessageService
AddDotNetProject<
    Projects.LCH_Abp_MicroService_MessageService_DbMigrator,
    Projects.LCH_Abp_MicroService_MessageService>(
    builder:            builder, 
...
// WebhookService
AddDotNetProject<
    Projects.LCH_Abp_MicroService_WebhookService_DbMigrator,
    Projects.LCH_Abp_MicroService_WebhookService>(
    builder:            builder, 
...
// PlatformService
AddDotNetProject<
    Projects.LCH_Abp_MicroService_PlatformService_DbMigrator,
    Projects.LCH_Abp_MicroService_PlatformService>(
    builder:            builder, 
...
// WeChatService
builder.AddProject<Projects.LCH_Abp_MicroService_WeChatService>("WeChatService")
...
// WorkflowService
builder.AddProject<Projects.LCH_Abp_MicroService_WorkflowService>("WorkflowService")
...
// ApiGateway
var apigateway = builder.AddProject<Projects.LCH_Abp_MicroService_ApiGateway>("ApiGateway")
