using LCH.Abp.MicroService.AdminService;
...
#if DEBUG
        .MinimumLevel.Override("LCH.Abp.MicroService.AdminService", LogEventLevel.Debug)
#else
        .MinimumLevel.Override("LCH.Abp.MicroService.AdminService", LogEventLevel.Information)
#endif
