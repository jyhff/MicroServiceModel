using LCH.Abp.MicroService.TaskService;
...
#if DEBUG
        .MinimumLevel.Override("LCH.Abp.MicroService.TaskService", LogEventLevel.Debug)
#else
        .MinimumLevel.Override("LCH.Abp.MicroService.TaskService", LogEventLevel.Information)
#endif
