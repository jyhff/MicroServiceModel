using LCH.Abp.MicroService.WebhookService;
...
#if DEBUG
        .MinimumLevel.Override("LCH.Abp.MicroService.WebhookService", LogEventLevel.Debug)
#else
        .MinimumLevel.Override("LCH.Abp.MicroService.WebhookService", LogEventLevel.Information)
#endif
