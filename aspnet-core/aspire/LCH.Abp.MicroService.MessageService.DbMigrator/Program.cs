using LCH.Abp.MicroService.MessageService;
...
#if DEBUG
        .MinimumLevel.Override("LCH.Abp.MicroService.MessageService", LogEventLevel.Debug)
#else
        .MinimumLevel.Override("LCH.Abp.MicroService.MessageService", LogEventLevel.Information)
#endif
