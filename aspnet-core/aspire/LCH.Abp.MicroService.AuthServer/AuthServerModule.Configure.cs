...
using LCH.Abp.MicroService.AuthServer.Ui.Branding;
...
public partial class AuthServerModule
{
    ...
    private void ConfigureVirtualFileSystem()
    {
        ...
        {
            options.FileSets.AddEmbedded<AuthServerModule>("LCH.Abp.MicroService.AuthServer");
        });
    }
    ...
    private void ConfigureSecurity(IServiceCollection services, IConfiguration configuration, bool isDevelopment = false)
    {
        ...
        services
            ...
            "LCH.Abp.Application:DataProtection:Protection-Keys");
