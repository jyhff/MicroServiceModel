...
#if DEBUG
        .MinimumLevel.Override("LCH.Abp.MicroService.LocalizationService", LogEventLevel.Debug)
#else
        .MinimumLevel.Override("LCH.Abp.MicroService.LocalizationService", LogEventLevel.Information)
#endif
