...
public class ClientDataSeederContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        await CreateScopeAsync("lch-abp-application");
        await CreateApplicationAsync("lch-abp-application");
    }
    ...
    {
        await CreateApiScopeAsync("lch-abp-application");
    }
    ...
    private async Task CreateApiResourcesAsync()
    {
        ...
        await CreateApiResourceAsync("lch-abp-application", commonApiUserClaims);
    }
    ...
    private async Task CreateClientsAsync()
    {
        ...
        if (!vueClientId.IsNullOrWhiteSpace())
        {
            ...
            await CreateClientAsync(
                vueClientId,
                commonScopes.Union(new[] { "lch-abp-application" }),
