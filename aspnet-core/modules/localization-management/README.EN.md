...
* [LCH.Abp.Localization.Persistence](../localization/LCH.Abp.Localization.Persistence) - Localization persistence module, implements IStaticLocalizationSaver interface to persist local static resources to storage facilities
* [LCH.Abp.LocalizationManagement.Domain.Shared](./LCH.Abp.LocalizationManagement.Domain.Shared) - Domain layer shared module, defines error codes, localization, and module settings
* [LCH.Abp.LocalizationManagement.Domain](./LCH.Abp.LocalizationManagement.Domain) - Domain layer module, implements ILocalizationStore interface
* [LCH.Abp.LocalizationManagement.EntityFrameworkCore](./LCH.Abp.LocalizationManagement.EntityFrameworkCore) - Data access layer module, integrates EFCore
* [LCH.Abp.LocalizationManagement.Application.Contracts](./LCH.Abp.LocalizationManagement.Application.Contracts) - Application service layer shared module, defines external interfaces, permissions, and functionality restriction policies for managing localization objects
* [LCH.Abp.LocalizationManagement.Application](./LCH.Abp.LocalizationManagement.Application) - Application service layer implementation, implements localization object management interfaces
* [LCH.Abp.LocalizationManagement.HttpApi](./LCH.Abp.LocalizationManagement.HttpApi) - RestApi implementation, implements independent external RestApi interfaces
