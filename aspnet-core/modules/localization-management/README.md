...
* [LCH.Abp.Localization.Persistence](../localization/LCH.Abp.Localization.Persistence)					本地化持久化模块,实现IStaticLocalizationSaver接口以将本地静态资源持久化到存储设施  
* [LCH.Abp.LocalizationManagement.Domain.Shared](./LCH.Abp.LocalizationManagement.Domain.Shared)					领域层公共模块，定义了错误代码、本地化、模块设置  
* [LCH.Abp.LocalizationManagement.Domain](./LCH.Abp.LocalizationManagement.Domain)								领域层模块，实现 ILocalizationStore 接口  
* [LCH.Abp.LocalizationManagement.EntityFrameworkCore](./LCH.Abp.LocalizationManagement.EntityFrameworkCore)								数据访问层模块,集成EfCore  
* [LCH.Abp.LocalizationManagement.Application.Contracts](./LCH.Abp.LocalizationManagement.Application.Contracts)	应用服务层公共模块，定义了管理本地化对象的外部接口、权限、功能限制策略  
* [LCH.Abp.LocalizationManagement.Application](./LCH.Abp.LocalizationManagement.Application)						应用服务层实现，实现了本地化对象管理接口  
* [LCH.Abp.LocalizationManagement.HttpApi](./LCH.Abp.LocalizationManagement.HttpApi)								RestApi实现，实现了独立的对外RestApi接口  
