...
* 提供了动作类型等枚举定义
* [查看详细说明](rules-engine/LCH.Abp.RulesEngineManagement.Domain.Shared/README.md)
...
* 提供了基于内存缓存的工作流存储实现
* 定义了规则记录、工作流记录等领域模型
* [查看详细说明](rules-engine/LCH.Abp.RulesEngineManagement.Domain/README.md)
...
* 实现了工作流、规则等实体的数据库映射
* 实现了仓储接口
* [查看详细说明](rules-engine/LCH.Abp.RulesEngineManagement.EntityFrameworkCore/README.md)
...
* 定义了数据传输对象（DTOs）
* 定义了权限
* [查看详细说明](rules-engine/LCH.Abp.RulesEngineManagement.Application.Contracts/README.md)

### 1.5 Application

* 实现了规则记录和工作流记录的应用服务
* 提供了对象自动映射配置
* [查看详细说明](rules-engine/LCH.Abp.RulesEngineManagement.Application/README.md)

### 1.6 HttpApi

* 提供了RESTful风格的API接口
* 实现了规则和工作流的CRUD操作API
* [查看详细说明](rules-engine/LCH.Abp.RulesEngineManagement.HttpApi/README.md)
