# LCH.Abp.MessageService.EntityFrameworkCore
...
* [LCH.Abp.MessageService.Domain](../LCH.Abp.MessageService.Domain/README.md)
* `AbpEntityFrameworkCoreModule`

## 配置使用

1. 首先，需要安装 LCH.Abp.MessageService.EntityFrameworkCore 到你的项目中：

```bash
dotnet add package LCH.Abp.MessageService.EntityFrameworkCore
```
