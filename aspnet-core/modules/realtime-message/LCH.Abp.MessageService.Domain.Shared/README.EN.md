# LCH.Abp.MessageService.Domain.Shared
...
1. First, install the LCH.Abp.MessageService.Domain.Shared package to your project:

```bash
dotnet add package LCH.Abp.MessageService.Domain.Shared
```
