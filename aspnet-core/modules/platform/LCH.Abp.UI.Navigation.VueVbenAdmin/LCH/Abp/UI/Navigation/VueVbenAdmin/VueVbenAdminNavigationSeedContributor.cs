...
using ValueType = LCH.Platform.Datas.ValueType;

namespace LCH.Abp.UI.Navigation.VueVbenAdmin;
...
public class VueVbenAdminNavigationSeedContributor : NavigationSeedContributor
{
        ...
        MultiTenancySides multiTenancySides)
    {
        foreach (var menu in menus)
        {
            ...
            menuMeta.TryAdd("title", menu.DisplayName);
            menuMeta.TryAdd("icon", menu.Icon ?? "");
            menuMeta.TryAdd("orderNo", menu.Order);
            menuMeta.TryAdd("hideTab", false);
            menuMeta.TryAdd("ignoreAuth", false);
        ...
        MultiTenancySides multiTenancySides)
    {
        ...
        foreach (var item in items)
        {
            ...
            menuMeta.TryAdd("title", item.DisplayName);
            menuMeta.TryAdd("icon", item.Icon ?? "");
            menuMeta.TryAdd("orderNo", item.Order);
            menuMeta.TryAdd("hideTab", false);
            menuMeta.TryAdd("ignoreAuth", false);
