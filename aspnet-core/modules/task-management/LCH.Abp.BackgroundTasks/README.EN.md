...
* [IJobPublisher](/LCH/Abp/BackgroundTasks/IJobPublisher.cs): Job publishing interface, publishes specified jobs to the current node
* [IJobDispatcher](/LCH/Abp/BackgroundTasks/IJobDispatcher.cs): Job dispatching interface, dispatches specified jobs to specified nodes
* [IJobScheduler](/LCH/Abp/BackgroundTasks/IJobScheduler.cs): Scheduler interface, manages job scheduler for the current running node
* [IJobLockProvider](/LCH/Abp/BackgroundTasks/IJobLockProvider.cs): Job locking interface, locks specified jobs to prevent duplicate execution, lock duration is specified by **LockTimeOut**
* [IJobEventTrigger](/LCH/Abp/BackgroundTasks/IJobEventTrigger.cs): Job event trigger interface, listens to events before and after job execution
* [IJobStore](/LCH/Abp/BackgroundTasks/IJobStore.cs): Job persistence interface
