...
* [IJobPublisher](/LCH/Abp/BackgroundTasks/IJobPublisher.cs): 作业发布接口, 将指定作业发布到当前节点  
* [IJobDispatcher](/LCH/Abp/BackgroundTasks/IJobDispatcher.cs): 作业调度接口, 将指定作业调度到指定节点  
* [IJobScheduler](/LCH/Abp/BackgroundTasks/IJobScheduler.cs): 调度器接口, 管理当前运行节点作业调度器  
* [IJobLockProvider](/LCH/Abp/BackgroundTasks/IJobLockProvider.cs): 作业锁定接口, 指定作业加锁, 防止重复运行, 锁定时长参见作业 **LockTimeOut**  
* [IJobEventTrigger](/LCH/Abp/BackgroundTasks/IJobEventTrigger.cs): 作业事件触发器接口, 作业运行前与运行后监听接口  
* [IJobStore](/LCH/Abp/BackgroundTasks/IJobStore.cs): 作业持久化接口  
