...
namespace LCH.Abp.Elsa.EntityFrameworkCore.MySql.Migrations;
...
public class MySqlElsaDataBaseInstaller : IElsaDataBaseInstaller, ITransientDependency
{
    ...
    {
        var sqlScriptFileInfo = _virtualFileProvider.GetFileInfo("/LCH/Abp/Elsa/EntityFrameworkCore/MySql/Migrations/Initial.sql");
