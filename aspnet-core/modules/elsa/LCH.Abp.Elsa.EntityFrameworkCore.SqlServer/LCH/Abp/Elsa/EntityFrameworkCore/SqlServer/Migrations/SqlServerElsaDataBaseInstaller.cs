...
namespace LCH.Abp.Elsa.EntityFrameworkCore.SqlServer.Migrations;
...
public class SqlServerElsaDataBaseInstaller : IElsaDataBaseInstaller, ITransientDependency
{
    ...
    {
        var sqlScriptFileInfo = _virtualFileProvider.GetFileInfo("/LCH/Abp/Elsa/EntityFrameworkCore/SqlServer/Migrations/Initial.sql");
