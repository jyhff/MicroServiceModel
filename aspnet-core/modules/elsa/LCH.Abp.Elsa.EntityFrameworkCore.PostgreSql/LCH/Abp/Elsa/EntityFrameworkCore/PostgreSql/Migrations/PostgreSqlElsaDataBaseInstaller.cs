using LCH.Abp.Elsa.EntityFrameworkCore.Migrations;
...
namespace LCH.Abp.Elsa.EntityFrameworkCore.PostgreSql.Migrations;
...
public class PostgreSqlElsaDataBaseInstaller : IElsaDataBaseInstaller, ITransientDependency
{
    ...
    {
        var sqlScriptFileInfo = _virtualFileProvider.GetFileInfo("/LCH/Abp/Elsa/EntityFrameworkCore/PostgreSql/Migrations/Initial.sql");
