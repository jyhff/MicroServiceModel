...
using LCH.Abp.Account.Web.OAuth.Areas.Account.Controllers.Dtos;
using LCH.Abp.WeChat.Work.Authorize;
...
namespace LCH.Abp.Account.Web.OAuth.Areas.Account.Controllers;
