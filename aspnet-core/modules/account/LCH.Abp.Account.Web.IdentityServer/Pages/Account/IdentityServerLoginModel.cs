...
using LCH.Abp.Account.Web.ExternalProviders;
using LCH.Abp.Account.Web.Models;
using LCH.Abp.Account.Web.Pages.Account;
...
namespace LCH.Abp.Account.Web.IdentityServer.Pages.Account
{
    /// <summary>
    /// 重写登录模型,实现双因素登录
    /// </summary>
    ...
    [ExposeServices(
        typeof(LCH.Abp.Account.Web.Pages.Account.LoginModel), 
        typeof(IdentityServerLoginModel))]
    public class IdentityServerLoginModel : LCH.Abp.Account.Web.Pages.Account.LoginModel
    {
