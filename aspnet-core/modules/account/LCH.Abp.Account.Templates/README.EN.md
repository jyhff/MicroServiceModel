...
* `Abp.Account.MailConfirmLink` - Email Address Confirmation Template
  ...
  * Template file: `/LCH/Abp/Account/Emailing/Templates/MailConfirm.tpl`
...
* `Abp.Account.MailSecurityVerifyLink` - Email Security Verification Template
  ...
  * Template file: `/LCH/Abp/Account/Emailing/Templates/MailSecurityVerify.tpl`
  * Uses standard email layout
...
* Resource path: `/LCH/Abp/Account/Templates/Localization/Resources`
