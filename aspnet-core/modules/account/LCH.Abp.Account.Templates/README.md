...
* `Abp.Account.MailConfirmLink` - 邮件地址确认模板
  * 用于用户邮箱地址验证
  * 模板文件：`/LCH/Abp/Account/Emailing/Templates/MailConfirm.tpl`
  * 使用标准邮件布局

* `Abp.Account.MailSecurityVerifyLink` - 邮件安全验证模板
  * 用于邮箱安全验证
  * 模板文件：`/LCH/Abp/Account/Emailing/Templates/MailSecurityVerify.tpl`
  * 使用标准邮件布局
...
* 资源路径：`/LCH/Abp/Account/Templates/Localization/Resources`
