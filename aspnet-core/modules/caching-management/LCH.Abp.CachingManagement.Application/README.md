...
1. 首先需要安装相应的缓存实现模块，例如：[LCH.Abp.CachingManagement.StackExchangeRedis](../LCH.Abp.CachingManagement.StackExchangeRedis/README.md)
...
* [应用服务契约](../LCH.Abp.CachingManagement.Application.Contracts/README.md)
* [HTTP API](../LCH.Abp.CachingManagement.HttpApi/README.md)
* [领域层](../LCH.Abp.CachingManagement.Domain/README.md)
