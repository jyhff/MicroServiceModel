# LCH.Abp.Notifications.WxPusher
...
```bash
dotnet add package LCH.Abp.Notifications.WxPusher
```
...
[LCH.Abp.Notifications.WxPusher](https://github.com/colinin/abp-next-admin/tree/master/aspnet-core/modules/realtime-notifications/LCH.Abp.Notifications.WxPusher)
