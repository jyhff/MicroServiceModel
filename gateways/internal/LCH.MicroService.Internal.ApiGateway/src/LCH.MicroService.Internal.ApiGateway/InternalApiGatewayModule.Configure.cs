...
using LCH.MicroService.Internal.ApiGateway.Localization;
...
namespace LCH.MicroService.Internal.ApiGateway
{
    public partial class InternalApiGatewayModule
    {
        ...
        private void ConfigureVirtualFileSystem()
        {
            ...
            {
                options.FileSets.AddEmbedded<InternalApiGatewayModule>("LCH.MicroService.Internal.ApiGateway");
            });
        }
        ...
        private void ConfigureCaching(IConfiguration configuration)
        {
            Configure<AbpDistributedCacheOptions>(options =>
            {
                ...
                options.KeyPrefix = "LCH.Abp.Application";
                // 滑动过期30天
            ...
            services.AddCors(options =>
            {
                options.AddPolicy(DefaultCorsPolicyName, builder =>
                {
                    builder
                        ...
                        // 引用 LCH.Abp.AspNetCore.Mvc.Wrapper 包时可替换为 WithAbpWrapExposedHeaders
