...
```bash
# Short name: laa (LCH Abp AllInOne)
...
3. Open the `LCH.MicroService.Applications.Single` solution in your IDE for debugging or publishing
...
- `migrations/LCH.MicroService.Applications.Single.DbMigrator/appsettings.json`
- `LCH.MicroService.Applications.Single/appsettings.Development.json`
...
- Modify database connection information in `LCH.MicroService.Applications.Single.DbMigrator/appsettings.PostgreSql.json`
- Navigate to `LCH.MicroService.Applications.Single.EntityFrameworkCore.PostgreSql` project
- Run `dotnet ef database update`
- Wait for migration completion

2. Configure data initialization:

   - Modify database connection information in `LCH.MicroService.Applications.Single.DbMigrator/appsettings.json`
   - Ensure the correct database provider is selected

3. Execute data migration:
   - Run the `LCH.MicroService.Applications.Single.DbMigrator` project
   - Wait for migration to complete, basic table data will be initialized

### Service Startup

1. Run the `LCH.MicroService.Applications.Single` project
