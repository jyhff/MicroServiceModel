...
[![Build](https://github.com/colinin/abp-next-admin/actions/workflows/build.yml/badge.svg)](https://github.com/colinin/abp-next-admin/actions/workflows/build.yml)  [![NuGet](https://img.shields.io/nuget/v/LCH.Abp.Core.svg?style=flat-square)](https://www.nuget.org/packages/LCH.Abp.Core)
...
cd aspnet-core/services/admin/LCH.BackendAdminApp.Host
